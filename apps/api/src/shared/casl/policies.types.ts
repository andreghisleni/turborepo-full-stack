...
export const CheckPoliciesOrg = (...handlers: PolicyOrgHandler[]) => SetMetadata(CHECK_POLICIES_ORG_KEY, handlers);
...
export const CheckPoliciesApp = (...handlers: PolicyAppHandler[]) => SetMetadata(CHECK_POLICIES_APP_KEY, handlers);
